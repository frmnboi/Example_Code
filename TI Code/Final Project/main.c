...
//180000 translates to 60ms, the recommended minimum sensing period for the ultrasonic sensors.  15ms works
...
//	FPU_enableLazyStacking() ;
	...
	MAP_CS_setDCOFrequency(3E+6); // Set DCO clock source frequency 3E+6
...
void TA2_0_IRQHandler()
{
	...
	double var=(unsigned char)((double) timedelta2/(timedelta2+timedelta4)*pwmperiod);
...
//	return (rawping - 47628); //(int) ((float) (rawping - 47628) / 516);
	...
	//translating the actual data from the battery powered car:
	// 45224.71 is for 1 and 3/4
	// the regression predicts 48531, meaning a delta of 3306

	//new regression is 516*x+44322
	return (rawping-44322);
